...
@Component
public class OrderAcceptedEmailHandler implements EmailNotificationHandler {

    private static final Logger log =
            LoggerFactory.getLogger(OrderAcceptedEmailHandler.class);
    ...
    public void send(OrderEvent event) {
        ...
        log.info(
                "Order acceptance notification sent [email={}, shipmentNumber={}]",
